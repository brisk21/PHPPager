...
//{$this->CurrentUrl}={$this->TotalPages}   
    public function GetPagerContent()
    {
        $str = <<<EOD
<style>
	.Pagination {font-family:"宋体",Arial,Lucida,Verdana,Helvetica,sans-serif; font-size:12px; line-height:150%;margin:10px 0 0;padding:5px 0;text-align:center; height:20px; line-height:20px; font-family:Arial, Helvetica, sans-serif,"宋体";}   
